...
RNA and ADT principal components were used to construct a WNN-based graph for multimodal integration, followed by UMAP visualization.  Cell cluster annotations were based on reference annotations from Hao et al. (2021).
